...
key1 = "play_type"
key2 = "play_type_nfl"
play_type_relation = get_key_relations(df, key1, key2)
get_key_relations(df, key2, key1)
...
# save_name = "offsense_summary_2022"
key_to_check = "offense_detail"
save_name = "offsense_detail_summary_2022"
for team in teams:
    df_sub = df[(df["possession_team"] == team) &
                (df["offense_formation"]) &
                (df["offense_personnel"])].copy()
    entry = {"Team": [team,]}
...
sum_df = sum_df.sort_values(by=["Team"])
